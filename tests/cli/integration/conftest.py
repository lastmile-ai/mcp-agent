        ...
        try:
            ...
            try:
                ...
                if not api_token:
                    ...
                    nextauth_secret = os.environ.get("NEXTAUTH_SECRET", "testsecretfortestinglocalapidevelopmentonly")
                    ...
                    print(f"Generated test API token for user {test_user_id}: {api_token[:20]}...{api_token[-10:]}")

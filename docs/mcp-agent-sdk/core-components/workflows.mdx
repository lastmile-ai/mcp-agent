...
📌 **Reference gallery:** the [workflow examples](https://github.com/lastmile-ai/mcp-agent/tree/main/examples/workflows) walk through router, parallel, orchestrator, evaluator/optimizer, deep research, and swarm patterns built on these primitives.

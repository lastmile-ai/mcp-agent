...
<Info>
  Make sure you have [installed mcp-agent](/get-started/install) before proceeding.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="shuffle"
    href="/reference/configuration#model-provider-configuration"
  >
    Use Anthropic Claude, Azure, or other LLM providers
  </Card>
  <Card title="Build Integrations" icon="plug" href="https://github.com/lastmile-ai/mcp-agent/tree/main/examples">

...
We recommend using [uv](https://docs.astral.sh/uv/getting-started/installation/) to install and manage mcp-agent.

If you plan to use mcp-agent in your project, you can add it as a dependency with:
...
<Card title="Next Steps" icon="arrow-right" href="/get-started/quickstart">

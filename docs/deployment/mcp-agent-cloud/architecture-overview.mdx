...
- **Auth service** – issues API keys (`mcp-agent login`) and will host the OAuth 2.1 authorization server described in the [Authentication design](https://github.com/lastmile-ai/lm/docs-revamp/blob/main/mcp-agent9/docs/deployment/authentication/overview.mdx) (Beta).
...
- [Cloud overview →](/deployment/mcp-agent-cloud/overview)
- [Secrets & credential management →](/deployment/mcp-agent-cloud/manage-secrets)
- [Long-running tools & workflows →](/deployment/mcp-agent-cloud/long-running-tools)
- [Authentication modes →](/deployment/authentication/overview)

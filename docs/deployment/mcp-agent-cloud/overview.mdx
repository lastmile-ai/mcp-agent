...
<img
  ...
  alt="mcp-agent cloud infrastructure diagram showing Temporal cluster, edge, and container instances"
  width="721"
  height="758"
/>
...
<img
  src="https://github.com/user-attachments/assets/dcb9638c-0da2-4920-bb93-4fb59c92ca06"
  alt="Screenshot showing agents exposed as MCP servers with workflows, tools, and resources"
  width="593"
  height="406"
/>
...
<img
  src="https://github.com/user-attachments/assets/ed4733c9-a12c-4ff6-98a8-c08a053b5519"
  alt="Temporal UI screenshot showing workflow history for an mcp-agent deployment"
  width="647"
  height="467"
/>
...
- **OAuth 2.1 (preview)** – the platform’s authorization server follows the MCP OAuth specification, enabling end-to-end user authentication for enterprise scenarios. See [Authentication →](/deployment/authentication/overview).
...
- [Deploy your first agent →](/deployment/deployment-quickstart)
- [Dive into the architecture →](/deployment/mcp-agent-cloud/architecture-overview)
- [Manage secrets →](/deployment/mcp-agent-cloud/manage-secrets)
- [Long-running tools →](/deployment/mcp-agent-cloud/long-running-tools)
- [Use-case guides →](/deployment/use-cases/deploy-agents)

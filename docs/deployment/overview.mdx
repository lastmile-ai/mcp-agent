...
<img
  src="https://github.com/user-attachments/assets/525f1d27-c695-4a40-9bfb-c983a5650761"
...
- **Plain MCP servers** – use FastMCP or `@app.tool` only and deploy without workflows when you just need stateless tools. [Deploy an MCP server →](/deployment/mcp-agent-cloud/deploy-mcp-server)
...
<CardGroup cols={2}>
  <Card title="Deployment Quickstart" icon="rocket" href="/deployment/deployment-quickstart">
    Hands-on walk-through from project to production
  </Card>
  <Card title="mcp-agent Cloud" icon="cloud" href="/deployment/mcp-agent-cloud/overview">
    Deep dive into the managed architecture & lifecycle
  </Card>
  <Card title="Authentication" icon="shield-check" href="/deployment/authentication/overview">
  ...
  <Card title="Use cases" icon="diagram-project" href="/deployment/use-cases/deploy-agents">
